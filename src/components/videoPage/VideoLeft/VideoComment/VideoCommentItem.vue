<template>
  <div class="comment-item">
        ...
        <div class="reply">
          ...
          <div class="reply-info">
            ...
            <span
              ...
              >回复</span
            >
            <div class="showReply" v-if="replyData.length" @click="toggleReply">
              展开
              <el-icon v-if="!isShowReply"><ArrowDown /></el-icon>
              <el-icon v-if="isShowReply"><ArrowUp /></el-icon>
            </div>
          </div>
        </div>
      </div>
    ...
    <Transition name="fade">
      <div v-if="isShowReply" style="overflow: hidden">
        <VideoCommentReply
